...
export default function Futures() {
  ...
  useEffect(() => {
    ...
    axios.get('/api/ai-signals')
      .then(res => setAiSignals(res.data.filter(s => s.trade_type === 'Futures')))
      .catch(() => setAiSignals([]))
      ...
      <div style={{ position: 'relative', zIndex: 1, fontFamily: 'Inter, Poppins, Satoshi, Arial, sans-serif', color: '#f5f6fa' }}>
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="text-center space-y-4">
            <h1 className="text-4xl font-bold text-foreground">Futures Trading</h1>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Trade perpetual and quarterly futures with AI-powered signals and backtesting.
            </p>
          </div>
